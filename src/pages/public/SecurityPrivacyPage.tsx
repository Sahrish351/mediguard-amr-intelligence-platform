...
export const SecurityPrivacyPage: React.FC = () => {
  ...
  return (
    <div className="space-y-20 py-8 text-left max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Bottom CTA */}
      <section className="p-8 sm:p-12 rounded-3xl bg-[#0B1F3A] text-white text-center space-y-4">
        <h3 className="text-2xl sm:text-3xl font-bold font-heading">
          Verify Cryptographic Multi-Tenancy on MediGuard
        </h3>
        <p className="text-xs sm:text-sm text-slate-300 max-w-lg mx-auto">
          Our test harness executes automated verification validating cross-tenant isolation and immutable audit trails.
        </p>
        <div className="pt-2">
          <Link
            to="/login"
            className="px-6 py-3.5 rounded-xl bg-[#0D9488] hover:bg-[#0f766e] text-white font-bold text-xs transition-colors inline-flex items-center gap-2 shadow-md"
          >
