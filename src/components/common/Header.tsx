              ...
              <button
                ...
                className={`w-full flex items-center justify-between px-3.5 py-2 text-left transition-colors ${
                  org.id === currentOrg.id
                    ? 'bg-sky-50/70 text-[#0284C7] font-bold'
      ...
      <div className="flex items-center gap-2 sm:gap-3 shrink-0">
        ...
        {onOpenAIAssistant && (
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-indigo-50/70 hover:bg-indigo-100/70 text-indigo-700 border border-indigo-200/80 text-xs font-bold transition-all shadow-2xs cursor-pointer"
        ...
        <div className="relative" ref={profileRef}>
          ...
          >
            ...
            <div className="w-8 h-8 rounded-lg bg-teal-50 border border-teal-200 flex items-center justify-center text-[#0D9488] font-bold text-xs">
          ...
          {profileDropdownOpen && (
            <div className="absolute right-0 mt-2 w-64 rounded-2xl bg-white border border-slate-200 shadow-xl py-2 z-50 text-xs space-y-1 animate-in fade-in zoom-in-95 duration-100">
              <div className="px-4 py-2.5 border-b border-slate-100 space-y-0.5">
                ...
                <div className="mt-1.5 inline-block px-2 py-0.5 rounded-full text-[10px] font-mono bg-teal-50 text-[#0D9488] border border-teal-200 font-semibold">
                  {currentRole?.name}
                </div>
              </div>
